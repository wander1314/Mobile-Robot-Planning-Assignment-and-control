...
def calculate_rmse_and_more():
    ...
    with open("/home/stuwork/Mobile-Robot-Planning-Assignment-and-control/src/quadrotor_simulator/so3_control/src/control_data.txt", "r") as file:
    ...
    with open("/home/stuwork/Mobile-Robot-Planning-Assignment-and-control/src/quadrotor_simulator/so3_control/src/control_timedata.txt", "r") as file:
        lines = file.readlines()
        for i, line in enumerate(lines):
    ...
    overall_score = rmse + total_time/300 + total_length/150+additional_score

    return rmse, total_time, total_length, additional_score,overall_score


def check_additional_file():
    file_path = "/home/stuwork/Mobile-Robot-Planning-Assignment-and-control/src/quadrotor_simulator/so3_control/src/issafe.txt"  # 替换为实际的文件路径
    try:
